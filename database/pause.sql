...
ALTER TABLE `user` CHANGE `created_on` `created_on` DATETIME NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `video` CHANGE `created_on` `created_on` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;